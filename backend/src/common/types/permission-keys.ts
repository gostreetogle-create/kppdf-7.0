...
export const PERMISSION_KEYS = {
  ...
  IMPORTS_DELETE: 'IMPORTS_DELETE',
  // === BOM domain (PSL-012, see docs/backend/RBAC-SCHEME.md) ===
  MATERIALS_READ: 'MATERIALS_READ',
  MATERIALS_WRITE: 'MATERIALS_WRITE',
  MATERIALS_DELETE: 'MATERIALS_DELETE',
  MODULES_READ: 'MODULES_READ',
  MODULES_WRITE: 'MODULES_WRITE',
  MODULES_DELETE: 'MODULES_DELETE',
  WORKTYPES_READ: 'WORKTYPES_READ',
  WORKTYPES_WRITE: 'WORKTYPES_WRITE',
  WORKTYPES_DELETE: 'WORKTYPES_DELETE',
